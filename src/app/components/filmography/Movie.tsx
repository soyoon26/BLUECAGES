...
const moviesData = [
  {
    ...
    category: "조연작",
    platforms: [
      { src: images.넷플릭스, link: "https://www.netflix.com" },
      { src: images.왓챠, link: "https://www.watcha.com" },
    ],
    trailers: [
      {
  ...
  },
  {
    ...
    category: "주연작",
    platforms: [
      { src: images.시리즈온, link: "https://www.netflix.com" },
      { src: images.웨이브, link: "https://www.watcha.com" },
      { src: images.유플러스, link: "https://www.watcha.com" },
    ],
    trailers: [
      {
  ...
  },
  {
    ...
    genre: "애니메이션, 로맨스",
    category: ["주연작", "공개예정"],
    platforms: [{ src: images.넷플릭스, link: "https://www.netflix.com" }],
    trailers: [],
  },
  {
    id: 8,
